...
use App\Http\Controllers\QrcodeguestController;
...
Route::get('/test', [App\Http\Controllers\QrcodeguestController::class, 'index2'])->name('home2');
Route::post('/test', [App\Http\Controllers\QrcodeguestController::class, 'store'])->name('stores');
Auth::routes();



Route::get('/home', [App\Http\Controllers\QrcodeController::class, 'index'])->name('home');
